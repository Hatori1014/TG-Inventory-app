...
describe('PurchasesListComponent', () => {
  ...
  function create(): PurchasesListComponent {
    const fixture = TestBed.createComponent(PurchasesListComponent);
    httpMock
      .expectOne((r) => r.url.endsWith('/purchases'))
  ...
  it('previousPage() does nothing on the first page', () => {
    ...
    httpMock.expectNone((r) => r.url.endsWith('/purchases'));
  ...
  it('nextPage() advances and requests the next page', () => {
    ...
    const req = httpMock.expectOne((r) => r.url.endsWith('/purchases'));
